...
<div className={styles.homeCont}>
  ...
  <h3 className={styles.contentHeading}>Up to <span>60% off</span> on all items till <span>September 11</span></h3>
  <button className={styles.shop}>
    <Link to="" >
      Shop now 
    <h4><MdArrowForwardIos /></h4>
    </Link>
...
<section className={styles.collection_container}>
  ...
  <div className={styles.collections}>
    ...
    <div>
        <img src='Images/vector_3.png' alt='' className={styles.vector_3} />
      ...
      <div>
        <img src='Images/vector_4.png' alt='' className={styles.vector_4} />
      </div>
      </div>
  </div>
</section>
